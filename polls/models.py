...
class Onlinedock(models.Model):
    job_name = models.CharField(max_length=1000, blank=True, null=True)
    prep_protein = models.FileField('origin_files/', blank=True, null=True)
    mut_protein = models.FileField('mutate_files/', blank=True, null=True)
    prep_pov = models.FileField('prep_pov_files/', blank=True, null=True)
    mut_pov = models.FileField('mut_pov_files/', blank=True, null=True)


class SubmitParamter(models.Model):

    ### online-dock ###
    # online_dock_jobname = models.CharField(max_length=1000, blank=True, null=True)
    # origin_protein = models.FileField('origin_files/', blank=True, null=True)
    # mutate_protein = models.FileField('mutate_files/', blank=True, null=True)
    # prep_pov = models.FileField('prep_pov_files/', blank=True, null=True)
    # mut_pov = models.FileField('mut_pov_files/', blank=True, null=True)
